...
from src.render.space import (
	tile_to_screen_coords,
	screen_to_tile_coords,
)
...
class SpaceTest(unittest.TestCase):
	...
	def test__tile_to_screen_coords__northwest(self):
		...
		self.viewport.camera_pos = (0, 0)
		result1 = tile_to_screen_coords((0, 0), self.viewport)
		self.assertEqual(result1, (400, 300))
		result2 = tile_to_screen_coords((-1, -1), self.viewport)
	...
	def test__tile_to_screen_coords__southeast(self):
		...
		self.viewport.camera_pos = (0, 0)
		result = tile_to_screen_coords((1, 1), self.viewport)
		expected_x = 400
		expected_y = 288
	...
	def test__screen_to_tile_coords__northwest(self):
		...
		result = screen_to_tile_coords(screen_coords, self.viewport)
	...
	def test__screen_to_tile_coords__round_trip(self):
		self.viewport.camera_orientation = Direction.NORTHWEST
		tile_coords = (3, 3)
		screen_coords = tile_to_screen_coords(tile_coords, self.viewport)
		result = screen_to_tile_coords(screen_coords, self.viewport)
